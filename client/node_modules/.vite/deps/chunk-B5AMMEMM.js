...
var require_useThemeWithoutDefault = __commonJS({
  "node_modules/@mui/system/useThemeWithoutDefault.js"(exports) {
    ...
    var React92 = _interopRequireWildcard(require_react());
    ...
    function useTheme3(defaultTheme2 = null) {
      const contextTheme = React92.useContext(_styledEngine.ThemeContext);
...
init_extends();
var _excluded29 = ["defaultProps", "mixins", "overrides", "palette", "props", "styleOverrides"];
...
function adaptV4Theme(inputTheme) {
  ...
  const {
    ...
    props = {},
    styleOverrides = {}
  } = inputTheme, other = _objectWithoutPropertiesLoose(inputTheme, _excluded29);
...
var Popper3 = React77.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
...
true ? ListSubheader.propTypes = {
   ...
   * @default 'default'
   */
  color: import_prop_types33.default.oneOf(["default", "inherit", "primary"]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
...
var IconButton = React80.forwardRef(function IconButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime53.jsx)(IconButtonRoot, _extends({
    className: clsx_default(classes.root, className),
    centerRipple: true,
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types35.default.node, (props) => {
    const found = React80.Children.toArray(props.children).some((child) => React80.isValidElement(child) && child.props.onClick);
    if (found) {
...
var Cancel_default = createSvgIcon((0, import_jsx_runtime57.jsx)("path", {
...
var Chip = React84.forwardRef(function Chip2(inProps, ref) {
  ...
  if (onDelete) {
    ...
    }) : (0, import_jsx_runtime58.jsx)(Cancel_default, {
  ...
  return (0, import_jsx_runtime59.jsxs)(ChipRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ...
    children: [avatar || icon, (0, import_jsx_runtime58.jsx)(ChipLabel, {
...
var FormControlContext2 = React85.createContext(void 0);
if (true) {
...
function useFormControl() {
  return React86.useContext(FormControlContext_default);
}
...
var InputBase = React88.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime62.jsxs)(React88.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, (0, import_jsx_runtime62.jsxs)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, (0, import_jsx_runtime61.jsx)(FormControlContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime61.jsx)(Input3, _extends({
          ownerState,
...
var AutocompleteRoot = styled_default("div", {
  ...
  overridesResolver: (props, styles2) => {
    ...
    return [{
      ...
      [`& .${autocompleteClasses_default.tag}`]: styles2[`tagSize${capitalize_default(size3)}`]
    }, {
...
var Autocomplete = React91.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index2) => {
        ...
        return (0, import_jsx_runtime65.jsx)(Chip_default, _extends({
  ...
  const defaultRenderOption = (props2, option) => {
    ...
    return (0, import_jsx_runtime65.jsx)("li", _extends({}, otherProps, {
  ...
  const renderAutocompletePopperChildren = (children) => (0, import_jsx_runtime65.jsx)(AutocompletePopper, _extends({
    as: PopperComponent,
    disablePortal,
    style: {
    ...
    children: (0, import_jsx_runtime65.jsx)(AutocompletePaper, _extends({
      ownerState,
      as: PaperComponent
    }, paperSlotProps, {
  ...
  if (groupedOptions.length > 0) {
    autocompletePopper = renderAutocompletePopperChildren((0, import_jsx_runtime65.jsx)(AutocompleteListbox, _extends({
      as: ListboxComponent,
      className: classes.listbox,
      ownerState
    ...
    autocompletePopper = renderAutocompletePopperChildren((0, import_jsx_runtime65.jsx)(AutocompleteLoading, {
      className: classes.loading,
      ownerState,
      children: loadingText
    }));
  } else if (groupedOptions.length === 0 && !freeSolo && !loading) {
    autocompletePopper = renderAutocompletePopperChildren((0, import_jsx_runtime65.jsx)(AutocompleteNoOptions, {
...
true ? Autocomplete.propTypes = {
   ...
   * @default false
   */
  autoComplete: import_prop_types40.default.bool,
  /**
   * If `true`, the first option is automatically highlighted.
   * @default false
   */
  autoHighlight: import_prop_types40.default.bool,
  /**
   ...
   * @default false
   */
  autoSelect: import_prop_types40.default.bool,
  /**
   ...
   * @default false
   */
  blurOnSelect: import_prop_types40.default.oneOfType([import_prop_types40.default.oneOf(["mouse", "touch"]), import_prop_types40.default.bool]),
  /**
   * Props applied to the [`Chip`](/material-ui/api/chip/) element.
   */
  ChipProps: import_prop_types40.default.object,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  clearIcon: import_prop_types40.default.node,
  /**
   ...
   */
  clearOnBlur: import_prop_types40.default.bool,
  /**
   * If `true`, clear all values when the user presses escape and the popup is closed.
   * @default false
   */
  clearOnEscape: import_prop_types40.default.bool,
  /**
   ...
   * @default 'Clear'
   */
  clearText: import_prop_types40.default.string,
  /**
  ...
  componentsProps: import_prop_types40.default.shape({
    clearIndicator: import_prop_types40.default.object,
    paper: import_prop_types40.default.object,
    popper: import_prop_types40.default.object,
    popupIndicator: import_prop_types40.default.object
  }),
  /**
   * The default value. Use when the component is not controlled.
   * @default props.multiple ? [] : null
   */
  defaultValue: chainPropTypes(import_prop_types40.default.any, (props) => {
   ...
   * @default false
   */
  disableClearable: import_prop_types40.default.bool,
  /**
   * If `true`, the popup won't close when a value is selected.
   * @default false
   */
  disableCloseOnSelect: import_prop_types40.default.bool,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * @returns {Value[]}
   */
  filterOptions: import_prop_types40.default.func,
  /**
   * If `true`, hide the selected options from the list box.
   * @default false
   */
  filterSelectedOptions: import_prop_types40.default.bool,
  /**
   * Force the visibility display of the popup icon.
   * @default 'auto'
   */
  forcePopupIcon: import_prop_types40.default.oneOfType([import_prop_types40.default.oneOf(["auto"]), import_prop_types40.default.bool]),
  /**
   * If `true`, the Autocomplete is free solo, meaning that the user input is not bound to provided options.
   * @default false
   */
  freeSolo: import_prop_types40.default.bool,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   * @default (more) => `+${more}`
   */
  getLimitTagsText: import_prop_types40.default.func,
  /**
   ...
   * @returns {boolean}
   */
  getOptionDisabled: import_prop_types40.default.func,
  /**
   ...
   */
  getOptionKey: import_prop_types40.default.func,
  /**
   ...
   * @returns {string}
   */
  groupBy: import_prop_types40.default.func,
  /**
   * If `true`, the component handles the "Home" and "End" keys when the popup is open.
   * It should move focus to the first option and last option, respectively.
   * @default !props.freeSolo
   */
  handleHomeEndKeys: import_prop_types40.default.bool,
  /**
   ...
   * @default false
   */
  includeInputInList: import_prop_types40.default.bool,
  /**
   * The input value.
   */
  inputValue: import_prop_types40.default.string,
  /**
   ...
   * @returns {boolean}
   */
  isOptionEqualToValue: import_prop_types40.default.func,
  /**
   ...
   * @default 'ul'
   */
  ListboxComponent: import_prop_types40.default.elementType,
  /**
   * Props applied to the Listbox element.
   */
  ListboxProps: import_prop_types40.default.object,
  /**
   ...
   * @default 'Loading…'
   */
  loadingText: import_prop_types40.default.node,
  /**
   ...
   * @default 'No options'
   */
  noOptionsText: import_prop_types40.default.node,
  /**
   ...
   */
  onHighlightChange: import_prop_types40.default.func,
  /**
   ...
   */
  onInputChange: import_prop_types40.default.func,
  /**
   * @ignore
   */
   ...
   * @default false
   */
  openOnFocus: import_prop_types40.default.bool,
  /**
   ...
   * @default 'Open'
   */
  openText: import_prop_types40.default.string,
  /**
   * Array of options.
   */
  options: import_prop_types40.default.array.isRequired,
  /**
   ...
   */
  popupIcon: import_prop_types40.default.node,
  /**
   ...
   * @returns {ReactNode}
   */
  renderGroup: import_prop_types40.default.func,
  /**
   * Render the input.
   *
   * @param {object} params
   * @returns {ReactNode}
   */
  renderInput: import_prop_types40.default.func.isRequired,
  /**
   ...
   * @returns {ReactNode}
   */
  renderOption: import_prop_types40.default.func,
  /**
   ...
   * @returns {ReactNode}
   */
  renderTags: import_prop_types40.default.func,
  /**
   * If `true`, the input's text is selected on focus.
   * It helps the user clear the selected value.
   * @default !props.freeSolo
   */
  selectOnFocus: import_prop_types40.default.bool,
  /**
   * The size of the component.
   * @default 'medium'
   */
   ...
   */
  value: chainPropTypes(import_prop_types40.default.any, (props) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-B5AMMEMM.js.map
